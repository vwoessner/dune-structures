#ifndef DUNE_BLOCKLAB_UTILITIES_ENUMERATE_HH
#define DUNE_BLOCKLAB_UTILITIES_ENUMERATE_HH
 ...
 *  to use it in their code. For a usage example, see the test in testenumerate.cc!
 */
